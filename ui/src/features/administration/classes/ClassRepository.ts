...
/**
 * Serialized class type for storage (dates as ISO strings)
 */
type SerializedClass = Omit<Class, 'createdAt' | 'updatedAt'> & {
  createdAt: string
  updatedAt: string
}
...
export class IndexedDBClassRepository implements ClassRepository {
   ...
   */
  private serializeClass(classObj: Class): SerializedClass {
    return {
      ...classObj,
   ...
   */
  private deserializeClass(data: SerializedClass): Class {
    return {
      ...data,
...
export const classRepository = {
  get findAll() {
    return this._ensureInstance().findAll.bind(this._ensureInstance())
  },
  get findById() {
    return this._ensureInstance().findById.bind(this._ensureInstance())
  },
  get create() {
    return this._ensureInstance().create.bind(this._ensureInstance())
  },
  get update() {
    return this._ensureInstance().update.bind(this._ensureInstance())
  },
  get delete() {
    return this._ensureInstance().delete.bind(this._ensureInstance())
  },
  _ensureInstance() {
    if (!_classRepository) {
