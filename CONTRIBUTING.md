...
- **UI text** must be in German with correct umlauts (ä, ö, ü, etc.)
...
The UI follows a **use-case based** (feature-first) folder structure. All files for a specific entity live together in one folder:
